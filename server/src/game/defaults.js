...
export const ATTRIBUTES = [
  {
    ...
    name: 'Strength',
    short: 'STR',
    blurb: 'The gym, heavy work, anything that asks the body for effort.',
  ...
  },
  {
    ...
    name: 'Intelligence',
    short: 'INT',
    blurb: 'Code, study, problems held until they give way.',
  ...
  },
  {
    ...
    name: 'Vitality',
    short: 'VIT',
    blurb: 'Sleep, food, water, the upkeep of a life.',
...
export const DIFFICULTIES = [
  ...
  { id: 'normal', name: 'Normal', xp: 45, gold: 18, rank: 2, hint: 'Real effort.', order: 2 },
  { id: 'hard', name: 'Hard', xp: 80, gold: 34, rank: 3, hint: 'You will feel it.', order: 3 },
  { id: 'epic', name: 'Epic', xp: 140, gold: 62, rank: 4, hint: 'The big one.', order: 4 },
];
...
export const SHOP_ITEMS = [
  ...
  { id: 'title-scholar', kind: 'title', name: 'Scholar of the Deep Shelf', description: 'Granted to a Mind that outgrew its library.', price: 1100, requiresLevel: 10, payload: { title: 'Scholar of the Deep Shelf' }, order: 12 },
  { id: 'title-ascendant', kind: 'title', name: 'the Ascendant', description: 'Reserved. Most never buy it; fewer still earn the level for it.', price: 4000, requiresLevel: 20, payload: { title: 'the Ascendant' }, order: 13 },

  { id: 'elixir-xp', kind: 'consumable', name: 'Elixir of Focus', description: '+50% XP on your next 5 completions. Stacks with your streak.', price: 220, requiresLevel: 1, stackable: true, payload: { effect: 'xpElixir', charges: 5 }, order: 20 },
  { id: 'shield-streak', kind: 'consumable', name: 'Streak Ward', description: 'Absorbs one missed day so a long chain survives a bad night.', price: 380, requiresLevel: 3, stackable: true, payload: { effect: 'streakShield', charges: 1 }, order: 21 },
